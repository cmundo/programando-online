...
function listar_categoria()
{
	...
	if($x->numrows()==0)
	{
		echo "
		<div class='sin-datos'>
			<p>Lo siento no hay ningún manual de <span>".$_GET["categoria"]."</span> en este momento, disculpen las molestias.</p>
		</div>
		";
	}
	else
	{
		echo "<h3 class='cabecera-general'>Manuales de la sección <span style='font-weight:bold'>".ucwords($_GET["categoria"])."</span></h3>";
...
function listar_subcategoria()
{
	...
	else
	{
		...
		<div class="listado-titulo">
			...
			<h3 class="listado-cabecera">Manual de <span>'.strtoupper($_GET["subcategoria"]).'</span></h3>
		</div>
